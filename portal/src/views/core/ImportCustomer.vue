    ...
    <div class="mx-auto w-full max-w-md">
      ...
      <div class="mb-10">
        ...
        <a :href="customerTemplateUrl" download>
          <div class="rounded-lg bg-green-600 p-4 text-xl text-white shadow">
      ...
      <div class="mb-10">
        <label for="upload">
          <label class="mb-2 block font-medium text-slate-600">
            CSV with customer data
          </label>

          <div
            class="w-full rounded-lg border bg-slate-500 p-6 text-center text-white"
          >
            <svg
