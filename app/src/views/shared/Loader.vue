...
<template>
  <div
    class="fixed left-0 top-0 z-40 flex h-screen w-screen items-center justify-center bg-black bg-opacity-40 backdrop-blur"
  >
    <div class="max-w-lg rounded-lg bg-zinc-50 px-12 py-12 md:px-16">
      <div class="pb-8 text-center">
        <svg
          aria-hidden="true"
          class="inline h-20 w-20 animate-spin fill-green-600 text-zinc-200"
          viewBox="0 0 100 101"
          fill="none"
      ...
      <p v-else class="text-2xl font-medium">
        {{
          loaderStore.customLoaderMessage === null
            ? "... loading ..."
