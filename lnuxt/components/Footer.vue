  ...
  >
    <div class="flex flex-col-reverse gap-8 pb-8 md:flex-row md:pb-20">
      <div class="flex flex-col gap-2 md:basis-1/4">
        ...
        <!-- @todo -->
        <NuxtLink to="/contact" class="w-max font-light">Contact us</NuxtLink>
        <NuxtLink to="/pricing" class="w-max font-light">Pricing</NuxtLink>
        <NuxtLink to="/about" class="w-max font-light">About us</NuxtLink>
